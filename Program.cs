...
namespace Phase1project
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(@"C:\Rainbowdata\Teacher.txt", FileMode.Open))
            ...
            {
                List<Teacher> listTeachers = new List<Teacher>();
                string teacherfile = "C:\\Rainbowdata\\Teacher.txt";
            ...
            static void create()
            {
                ...
                string UIClass = "";
                string UIsection = "";
                using (FileStream fs = new FileStream(@"C:\Rainbowdata\Teacher.txt", FileMode.Append))
